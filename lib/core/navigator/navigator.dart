...
//<editor-fold desc="TO">
  ...
  static Future<T?> to<T extends Object?>(
    ...
    return _navigatorKey.currentState!.push<T>(_pageRouter.build(page, transition: transition, options: options));
  }
...
//<editor-fold desc="TO NAMED">
  // pushNamed
  static Future<T?> toNamed<T extends Object?>(NamedRoutes namedRoute, {Object? arguments}) {
